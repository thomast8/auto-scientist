...
:mod:`auto_core.agents.prediction_query`, a stdlib-only module that
...
from auto_core.agents._mcp_base import MCPToolSpec, build_mcp_server_config, register_mcp_tool
from auto_core.agents.prediction_query import normalize_args as _normalize_args
from auto_core.agents.prediction_query import query as _query
