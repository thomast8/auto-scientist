...
from auto_reviewer.agents.hunter import HUNTER_PLAN_SCHEMA
...
from auto_reviewer.schemas import CompletenessAssessmentOutput, HunterPlanOutput
...
async def _query_stop_agent(
    ...
    """
    from auto_reviewer.agents.adversary import _query_critic
...
async def run_single_stop_debate(
    ...
    """
    from auto_reviewer.agents.adversary import _build_critic_tools_and_mcp
