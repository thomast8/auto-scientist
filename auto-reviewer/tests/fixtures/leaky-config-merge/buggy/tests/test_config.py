...
def test_env_override_is_applied_in_place() -> None:
    # Added in the refactor: sanity check that the returned dict is
    # the same object as the input (in-place mutation).
